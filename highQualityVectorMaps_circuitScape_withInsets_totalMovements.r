...
allClasses = c(0,1000,2000,3000,5000,8000,34000)
...
imageFile <- paste(imageDir, "/hiie2_total.tif", sep="")
...
legendLabs = cbind(round(breaks[[2]][1:5] / 1000, 1), round(breaks[[2]][2:6] / 1000, 1))
legendLabs = apply(legendLabs, 1, function(x) {paste(x[1], x[2], sep="-")})
legendLenVal = c(legendLabs, paste(">", round(breaks[[2]][6] / 1000, 0), sep=""))
